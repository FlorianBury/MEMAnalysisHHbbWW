...
baseDirME = "/home/users/f/b/fbury/HHMEM/MEMWeight/MatrixElements/ttbar_fullyLeptonic/"
matrix_element_lib = baseDirME .. "build/libme_ttbar_fullyLeptonic.so"
...
--
    ...
    -- "Name" of the matrix element: hidden inside the code exported from madgraph
      matrix_element = 'ttbar_fullyLeptonic_sm_P1_Sigma_sm_gg_epvebemvexbx',
