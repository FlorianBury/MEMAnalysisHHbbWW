...
#include <P1_Sigma_sm_gg_udxbduxbx.h> 
...
P1_Sigma_sm_gg_udxbduxbx::P1_Sigma_sm_gg_udxbduxbx(const ParameterSet&
    configuration)
{
  ...
  mapFinalStates[{2, -1, 5, 1, -2, -5}] = 
  {
    {
      &P1_Sigma_sm_gg_udxbduxbx::matrix_1_gg_ttx_t_wpb_wp_udx_tx_wmbx_wm_dux, 
      false, 
      {
        std::make_pair(21, 21), std::make_pair(21, 21), std::make_pair(21, 21),
            std::make_pair(21, 21)
      }, 
      256, 
      256
    ...
    , 
    {
      &P1_Sigma_sm_gg_udxbduxbx::matrix_1_uux_ttx_t_wpb_wp_udx_tx_wmbx_wm_dux, 
      true, 
      {
        std::make_pair(2, -2), std::make_pair(4, -4), std::make_pair(1, -1),
            ...
            std::make_pair(2, -2), std::make_pair(4, -4), std::make_pair(1,
            -1), std::make_pair(3, -3), std::make_pair(2, -2),
            std::make_pair(4, -4), std::make_pair(1, -1), std::make_pair(3, -3)
      }, 
      256, 
      36
    }
...
void P1_Sigma_sm_gg_udxbduxbx::resetHelicities() 
{
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_gg_udxbduxbx::compute(const std::pair < std::vector<double> ,
...
void P1_Sigma_sm_gg_udxbduxbx::calculate_wavefunctions(const int perm[], const
    int hel[])
{
...
double P1_Sigma_sm_gg_udxbduxbx::matrix_1_gg_ttx_t_wpb_wp_udx_tx_wmbx_wm_dux() 
{
  ...
  static const double cf[2][2] = {{48, -6}, {-6, 48}}; 
...
double P1_Sigma_sm_gg_udxbduxbx::matrix_1_uux_ttx_t_wpb_wp_udx_tx_wmbx_wm_dux() 
{
  ...
  // The color matrix
  static const double denom[2] = {1, 1}; 
  static const double cf[2][2] = {{81, 27}, {27, 81}}; 
...
REGISTER_MATRIX_ELEMENT("ttbar_fullyHadronic_sm_P1_Sigma_sm_gg_udxbduxbx",
    ttbar_fullyHadronic_sm::P1_Sigma_sm_gg_udxbduxbx);
