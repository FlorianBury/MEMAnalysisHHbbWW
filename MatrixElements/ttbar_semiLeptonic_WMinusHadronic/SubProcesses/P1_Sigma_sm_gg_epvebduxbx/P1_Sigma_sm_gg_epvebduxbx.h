...
class P1_Sigma_sm_gg_epvebduxbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_gg_epvebduxbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_gg_epvebduxbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_gg_epvebduxbx() = delete; 
    ...
    // Matrix elements
    double matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux(); 
    double matrix_1_uux_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_gg_epvebduxbx >> > mapFinalStates;
