...
#include <P1_Sigma_sm_gg_epvebduxbx.h> 
...
P1_Sigma_sm_gg_epvebduxbx::P1_Sigma_sm_gg_epvebduxbx(const ParameterSet&
    configuration)
{
  ...
  mapFinalStates[{-11, 12, 5, 1, -2, -5}] = 
  {
    {
      &P1_Sigma_sm_gg_epvebduxbx::matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux, 
      false, 
      {
    ...
    , 
    {
      &P1_Sigma_sm_gg_epvebduxbx::matrix_1_uux_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux, 
      true, 
      {
...
void P1_Sigma_sm_gg_epvebduxbx::resetHelicities() 
{
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_gg_epvebduxbx::compute(const std::pair < std::vector<double> ,
...
void P1_Sigma_sm_gg_epvebduxbx::calculate_wavefunctions(const int perm[], const
    int hel[])
{
...
double P1_Sigma_sm_gg_epvebduxbx::matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux() 
{
...
double P1_Sigma_sm_gg_epvebduxbx::matrix_1_uux_ttx_t_wpb_wp_epve_tx_wmbx_wm_dux() 
{
...
REGISTER_MATRIX_ELEMENT("ttbar_semiLeptonic_WMinusHadronic_sm_P1_Sigma_sm_gg_epvebduxbx", ttbar_semiLeptonic_WMinusHadronic_sm::P1_Sigma_sm_gg_epvebduxbx); 
