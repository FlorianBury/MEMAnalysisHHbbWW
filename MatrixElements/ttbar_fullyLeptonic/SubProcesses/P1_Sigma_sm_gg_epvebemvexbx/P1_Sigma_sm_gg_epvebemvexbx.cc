...
#include <P1_Sigma_sm_gg_epvebemvexbx.h> 
...
P1_Sigma_sm_gg_epvebemvexbx::P1_Sigma_sm_gg_epvebemvexbx(const ParameterSet&
    configuration)
{
  ...
  {
    {
      &P1_Sigma_sm_gg_epvebemvexbx::matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_emvex, 
      false, 
      {
        std::make_pair(21, 21)
      }, 
    ...
    , 
    {
      &P1_Sigma_sm_gg_epvebemvexbx::matrix_1_uux_ttx_t_wpb_wp_epve_tx_wmbx_wm_emvex, 
      true, 
      {
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_gg_epvebemvexbx::compute(const std::pair < std::vector<double>
...
void P1_Sigma_sm_gg_epvebemvexbx::calculate_wavefunctions(const int perm[],
    const int hel[])
{
...
double P1_Sigma_sm_gg_epvebemvexbx::matrix_1_gg_ttx_t_wpb_wp_epve_tx_wmbx_wm_emvex() 
{
...
double P1_Sigma_sm_gg_epvebemvexbx::matrix_1_uux_ttx_t_wpb_wp_epve_tx_wmbx_wm_emvex() 
{
...
REGISTER_MATRIX_ELEMENT("ttbar_fullyLeptonic_sm_P1_Sigma_sm_gg_epvebemvexbx",
    ttbar_fullyLeptonic_sm::P1_Sigma_sm_gg_epvebemvexbx);
