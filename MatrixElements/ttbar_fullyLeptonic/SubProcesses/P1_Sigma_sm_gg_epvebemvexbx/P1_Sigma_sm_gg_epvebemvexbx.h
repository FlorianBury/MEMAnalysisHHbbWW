...
class P1_Sigma_sm_gg_epvebemvexbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_gg_epvebemvexbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_gg_epvebemvexbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_gg_epvebemvexbx() = delete; 
    ...
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_gg_epvebemvexbx >> > mapFinalStates;
