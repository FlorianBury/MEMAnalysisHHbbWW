...
class P1_Sigma_sm_gg_udxbemvexbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_gg_udxbemvexbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_gg_udxbemvexbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_gg_udxbemvexbx() = delete; 
    ...
    double matrix_1_uux_ttx_t_wpb_wp_udx_tx_wmbx_wm_emvex(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_gg_udxbemvexbx >> > mapFinalStates;
