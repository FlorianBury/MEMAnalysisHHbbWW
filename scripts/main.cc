...
int main(int argc, char** argv) {
    ...
    ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double>> lep1_p4, lep2_p4, jet1_p4, jet2_p4, met_p4;

    ConfigurationReader my_reader("../confs/TTbar_FullyLeptonic.lua");
    Configuration my_config = my_reader.freeze();
    MoMEMta weight(my_config);

    lep1_p4.SetPxPyPzE(100, -200, 300, 500);
    lep2_p4.SetPxPyPzE(100, 50, 20, 200);
    jet1_p4.SetPxPyPzE(300, 400, 50, 700);
    jet2_p4.SetPxPyPzE(50, 40, -500, 600);
    met_p4.SetPxPyPzE(50, 40, 0, 300);
    ...
    std::vector<std::pair<double, double>> weights = weight.computeWeights({lep_minus, lep_plus, bjet1, bjet2},met_p4);
    std::cout<<weights.back().first<<std::endl;
    std::cout<<weights.back().second<<std::endl;
